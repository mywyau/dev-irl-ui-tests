...
const testEmail = "chouzhu882@gmail.com";
const testPassword = "turnip123";
...
test("Dev user logs in with Google and sees Dev-specific nav", async ({ page }) => {
  ...
  const devDashboardLink = page.getByRole("link", { name: "Dev Quests Dashboard" });
